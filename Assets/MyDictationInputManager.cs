...
namespace MREigo
{
    ...
    /// </summary>
    public class MyDictationInputManager : Singleton<MyDictationInputManager>, IInputSource
    {
#if UNITY_WSA || UNITY_STANDALONE_WIN
        /// <summary>
        ...
        public static DictationRecognizer DictationRecognizer { get { return dictationRecognizer; } }
...
public class MyDictationManager : Singleton<MyDictationManager>
{
#if UNITY_WSA || UNITY_STANDALONE_WIN
    /// <summary>
    /// Caches the text currently being displayed in dictation display text.
